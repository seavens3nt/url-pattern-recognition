...
@pytest.mark.parametrize(
    ...
    [
        ...
        lambda data: data.update(states='M0'),
        lambda data: data.update(debug=True),
        lambda data: data.update(start_state='MISSING'),
        lambda data: data.update(accepting_states=['MISSING']),
        lambda data: data.update(sink_state='MISSING'),
        lambda data: data.update(accepting_states=['M_sink']),
        lambda data: data['states'].append('M0'),
        lambda data: data.update(transitions=[]),
        lambda data: data['transitions'].pop('M0'),
        lambda data: data['transitions']['M0'].update(EXTRA='M_sink'),
