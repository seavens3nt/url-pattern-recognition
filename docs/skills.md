...
These are skills each role needs for its tasks, not claims about a member's current proficiency. Members should flag learning needs during planning.
...
Everyone should practice cloning, making a branch, committing, opening a PR, and reporting a reproducible bug.

## Codex skills included in this repository
- `.agents/skills/automata-development/SKILL.md`: preserves formal-language and simulator invariants when implementing automata work.
- `.agents/skills/sprint-maintenance/SKILL.md`: keeps sprint scope, evidence, blockers and status consistent.

These are project-local instructions for Codex when the repository is opened as a project. They do not install tools on teammates' computers or grant permissions to publish changes.
