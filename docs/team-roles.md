...
Three backend developers, two frontend developers, one QA tester, one paper lead, and Ranee as PM/setup owner. Backend and paper support do not change the accountable lead.
